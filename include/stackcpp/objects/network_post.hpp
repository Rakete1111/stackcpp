...
#ifndef STACKCPP_NETWORK_POST_HPP
#define STACKCPP_NETWORK_POST_HPP
...
inline namespace objects { struct network_post; }
network_post parse_network_post(const rapidjson::Value&);



inline namespace objects {
struct network_post final {
...
private:
    friend network_post stackcpp::parse_network_post(const rapidjson::Value&);

    // See [dcl.fct.def.default]/4 and [dcl.init.aggr]/1 for rational.
    network_post() noexcept {}
